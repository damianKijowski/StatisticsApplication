...
public class MatchController {
    ...
    public Matches getCompetitionMatches(@PathVariable String dateFrom, @PathVariable String dateTo) {
        return competitionMatchesService.getMatches(dateFrom, dateTo);
    }
    @GetMapping("/{id}")
    public Match getCompetitionMatch(@PathVariable String id) {
        return competitionMatchesService.getCompetitionMatch(id);
    }
    @GetMapping("/{league}/dateFrom={dateFrom}/dateTo={dateTo}")
    public Matches getCompetitionMatches(@PathVariable String league, @PathVariable String dateFrom, @PathVariable String dateTo) {
